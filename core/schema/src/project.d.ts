...
export declare type TypeRouterSchema = IApplicationSchema["router"];
export declare type TypePageSchema = IApplicationSchema["pages"][number];
/**
 * 物料组件协议：描述如何使用一个物料组件
...
export interface IComponentSchema {
     ...
     * 组件内联样式
     */
    style: JSExpression | Partial<Record<keyof CSSStyleDeclaration, JSExpression>>;
    /**
     * 组件发射事件
     */
    emits: Array<{
